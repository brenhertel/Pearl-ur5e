...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<sensor_accessor-request>)))
  ...
  (cl:format cl:nil "uint8 COMMAND_GET_SERIAL_NUMBER=1~%uint8 COMMAND_GET_FIRMWARE_VERSION=2~%uint8 COMMAND_GET_PRODUCTION_YEAR=4~%uint8 COMMAND_SET_ZERO=8~%uint8 command_id~%string command~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'sensor_accessor-request)))
  "Returns full string definition for message of type 'sensor_accessor-request"
  (cl:format cl:nil "uint8 COMMAND_GET_SERIAL_NUMBER=1~%uint8 COMMAND_GET_FIRMWARE_VERSION=2~%uint8 COMMAND_GET_PRODUCTION_YEAR=4~%uint8 COMMAND_SET_ZERO=8~%uint8 command_id~%string command~%~%~%"))
