...
record_time = 0
#global variable to keep track of subscriber handle
#sub_js = rospy.Subscriber('rosout', String, nothing)
#sub_tf = rospy.Subscriber('rosout', String, nothing)
#sub_wr = rospy.Subscriber('rosout', String, nothing)

#def shutdown_sub_node():
#	global sub_js
#	global sub_tf
#	global sub_wr
#	sub_js.unregister()
