...
class MoveGroupPythonInterface(object):
  ...
  def plan_cartesian_path(self, scale=1):
    ...
    filename = '/home/bhertel/catkin_ws/src/brendan_ur5e/src/scripts/recorded_demo 2022-06-01 09:11:33.h5'
    ...
    (n_dims, n_pts) = np.shape(pos_rot_data)
    ...
    starting_xyz_position[2] = pos_rot_data[2][0] + 0.01
    ...
    for i in range(1, n_pts):
      ...
      wpose.position.z = pos_rot_data[2][i] + 0.01
