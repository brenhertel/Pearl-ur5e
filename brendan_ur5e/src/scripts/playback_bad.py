...
class MoveGroupPythonInterface(object):
  ...
  def plan_cartesian_path(self, scale=1):
    ...
    y = np.array(get_traj.get('y'))
    z = np.array(get_traj.get('z'))
    #close out file
    hf.close()
    ...
    starting_xyz_position[0] = x[0]
    starting_xyz_position[1] = y[0]
    starting_xyz_position[2] = z[0]
