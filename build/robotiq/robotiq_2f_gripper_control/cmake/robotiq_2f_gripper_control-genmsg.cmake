...
set(MSG_I_FLAGS "-Irobotiq_2f_gripper_control:/home/bhertel/catkin_ws/src/robotiq/robotiq_2f_gripper_control/msg")
...
get_filename_component(_filename "/home/bhertel/catkin_ws/src/robotiq/robotiq_2f_gripper_control/msg/Robotiq2FGripper_robot_input.msg" NAME_WE)
add_custom_target(_robotiq_2f_gripper_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robotiq_2f_gripper_control" "/home/bhertel/catkin_ws/src/robotiq/robotiq_2f_gripper_control/msg/Robotiq2FGripper_robot_input.msg" ""
)

get_filename_component(_filename "/home/bhertel/catkin_ws/src/robotiq/robotiq_2f_gripper_control/msg/Robotiq2FGripper_robot_output.msg" NAME_WE)
add_custom_target(_robotiq_2f_gripper_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robotiq_2f_gripper_control" "/home/bhertel/catkin_ws/src/robotiq/robotiq_2f_gripper_control/msg/Robotiq2FGripper_robot_output.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robotiq_2f_gripper_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robotiq_2f_gripper_control\")")
  # install generated code
  install(
