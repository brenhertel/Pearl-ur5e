...
public:
    ...
    {
        Robotiq3FingerForm->setWindowTitle(QApplication::translate("Robotiq3FingerForm", "Form", 0));
        button_on->setText(QApplication::translate("Robotiq3FingerForm", "ON", 0));
        button_off->setText(QApplication::translate("Robotiq3FingerForm", "OFF", 0));
        group_mode->setTitle(QApplication::translate("Robotiq3FingerForm", "Mode", 0));
        button_basic->setText(QApplication::translate("Robotiq3FingerForm", "Basic", 0));
        button_wide->setText(QApplication::translate("Robotiq3FingerForm", "Wide", 0));
        button_pinch->setText(QApplication::translate("Robotiq3FingerForm", "Pinch", 0));
        button_scissor->setText(QApplication::translate("Robotiq3FingerForm", "Scissor", 0));
        group_position->setTitle(QApplication::translate("Robotiq3FingerForm", "Position", 0));
        button_open->setText(QApplication::translate("Robotiq3FingerForm", "Open", 0));
        button_close->setText(QApplication::translate("Robotiq3FingerForm", "Close", 0));
        button_send->setText(QApplication::translate("Robotiq3FingerForm", "SEND", 0));
#ifndef QT_NO_TOOLTIP
        check_send->setToolTip(QApplication::translate("Robotiq3FingerForm", "send all position values immediately", 0));
#endif // QT_NO_TOOLTIP
        check_send->setText(QApplication::translate("Robotiq3FingerForm", "immediately", 0));
        label_force->setText(QApplication::translate("Robotiq3FingerForm", "Force", 0));
        force_unit->setText(QApplication::translate("Robotiq3FingerForm", "N", 0));
        label_speed->setText(QApplication::translate("Robotiq3FingerForm", "Speed", 0));
        force_value->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        speed_value->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        speed_unit->setText(QApplication::translate("Robotiq3FingerForm", "mm/s", 0));
        pos_a->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        cur_a->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        pos_c->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        label_status_pos->setText(QApplication::translate("Robotiq3FingerForm", "Position", 0));
        label_status_cur->setText(QApplication::translate("Robotiq3FingerForm", "Current (mA)", 0));
        label->setText(QApplication::translate("Robotiq3FingerForm", "Finger", 0));
        pos_b->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        label_fb->setText(QApplication::translate("Robotiq3FingerForm", "B", 0));
        cur_b->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        label_fc->setText(QApplication::translate("Robotiq3FingerForm", "C", 0));
        label_fa->setText(QApplication::translate("Robotiq3FingerForm", "A", 0));
        cur_c->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        label_s->setText(QApplication::translate("Robotiq3FingerForm", "S", 0));
        pos_s->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
        cur_s->setText(QApplication::translate("Robotiq3FingerForm", "--", 0));
    } // retranslateUi
